...
export const seedDatabase: Database = {
  services: [
    {
      ...
      icon: 'building',
      heroImage: '/images/locations/menara-karya.webp',
      features: [
    ...
    },
    {
      ...
      icon: 'scale',
      heroImage: '/images/locations/bandung-mtc.webp',
      features: [
  ...
  rooms: [
    { id: 'room-mk-a', locationId: 'loc-menara-karya', name: 'Ruang Rapat Karya A', capacity: 8, pricePerHour: 150_000, active: true },
    { id: 'room-mk-b', locationId: 'loc-menara-karya', name: 'Ruang Rapat Karya B', capacity: 4, pricePerHour: 100_000, active: true },
    { id: 'room-wp-a', locationId: 'loc-wisma-perkasa', name: 'Ruang Rapat Perkasa', capacity: 6, pricePerHour: 100_000, active: true },
    { id: 'room-ep-a', locationId: 'loc-epiwalk', name: 'Ruang Rapat Epiwalk', capacity: 10, pricePerHour: 150_000, active: true },
    { id: 'room-cm-a', locationId: 'loc-cempaka-mas', name: 'Ruang Rapat Cempaka', capacity: 6, pricePerHour: 100_000, active: true },
    { id: 'room-bk-a', locationId: 'loc-bekasi', name: 'Ruang Rapat Celebration', capacity: 6, pricePerHour: 100_000, active: true },
  ...
  posts: [
    {
      ...
      cover: '/images/locations/menara-karya.webp',
      status: 'published',
    ...
    },
    {
      ...
      cover: '/images/locations/bandung-mtc.webp',
      status: 'published',
